...
import 'package:flutter_demos/paper/color_selector.dart';
import 'package:flutter_demos/paper/paper_app_bar.dart';
import 'package:flutter_demos/paper/stork_width_selector.dart';
...
class _PaperState extends State<Paper> with AutomaticKeepAliveClientMixin {
  ...
  void _onPanStars(DragStartDetails details) {
    _lines.add(Line(
